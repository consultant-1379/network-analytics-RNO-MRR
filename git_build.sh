...
function setRstate {
	...
	mv RNO-MMR/build/feature-release.xml RNO-MMR/build/feature-release.${rstate}.xml
...
function Arm104nexusDeploy {
	...
	ArtifactId=$module
	zipName=Ericsson-RNO-MMR
	
	echo "****"	
	echo "Deploying the zip /$zipName-19.2.zip as ${ArtifactId}${rstate}.zip to Nexus...."
